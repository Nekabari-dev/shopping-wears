...
<li class="category-icon"><a href="cart.php?id=<?php echo $id; ?>#"><i class="flaticon-menu"></i></a></li>
<li><a href="temp/admin/login.php?id=<?php echo $id; ?>"><i class="flaticon-user"></i></a></li>
<li><a href="cart.php?id=<?php echo $id; ?>#"><i class="flaticon-heart"></i></a></li>
<li class="cart-icon">
...
<li><a href="cart.php?id=<?php echo $id; ?>#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="cart.php?id=<?php echo $id; ?>#"><i class="flaticon-twitter-1"></i></a></li>
<li><a href="cart.php?id=<?php echo $id; ?>#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="cart.php?id=<?php echo $id; ?>#"><i class="flaticon-pinterest-1"></i></a></li>
</ul>
</nav>
</div>
...
<li>Taxes</li>
<li>Shipping Enter your address to view shipping options. <a href="cart.php?id=<?php echo $id; ?>#">Calculate
shipping</a>
</li>
</ul>
</td>
...
<a href="checkout.php?id=<?php echo $id; ?>" class="cart-proceed">Proceed to Checkout</a>
<a href="product.php?id=<?php echo $id; ?>" class="continue-shop">Continue to shopping</a>
</div>
</div>
</div>
</div>
...
<li><a href="cart.php?id=<?php echo $id; ?>#">Privacy Policy</a> </li>
<li><a href="cart.php?id=<?php echo $id; ?>#">Terms & Conditions</a></li>
<li><a href="cart.php?id=<?php echo $id; ?>#">Our Support</a></li>
<li><a href="cart.php?id=<?php echo $id; ?>#">Terms & Service</a></li>
<li><a href="cart.php?id=<?php echo $id; ?>#">Payment Policy</a></li>
</ul>
</div>
</div>
</div>
...
<li><a href="cart.php?id=<?php echo $id; ?>#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="cart.php?id=<?php echo $id; ?>#"><i class="flaticon-pinterest-1"></i></a></li>
<li><a href="cart.php?id=<?php echo $id; ?>#"><i class="flaticon-linkedin"></i></a></li>
<li><a href="cart.php?id=<?php echo $id; ?>#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="cart.php?id=<?php echo $id; ?>#"><i class="flaticon-twitter-1"></i></a></li>
</ul>
</div>
...
<div class="col-lg-6 ">
<div class="footer-copyring"> <p>Copyright 2021 EG Shop Fashion | Design By <a href="cart.php?id=<?php echo $id; ?>#">Egens Lab</a></p> </div>
</div>
<div class="col-lg-6">

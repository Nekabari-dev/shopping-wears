...
<li class="category-icon"><a href="faq.php#"><i class="flaticon-menu"></i></a></li>
<li><a href="dashboard.php"><i class="flaticon-user"></i></a></li>
<li><a href="faq.php#"><i class="flaticon-heart"></i></a></li>
<li class="cart-icon">
...
<li><a href="faq.php#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="faq.php#"><i class="flaticon-twitter-1"></i></a></li>
<li><a href="faq.php#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="faq.php#"><i class="flaticon-pinterest-1"></i></a></li>
</ul>
</nav>
</div>
...
<li><a href="index.php">FAQ <i class="bi bi-chevron-right"></i></a></li>
<li>FAQ</li>
</ul>
</div>
</div>
...
<li><a href="faq.php#">Our Support</a></li>
<li><a href="faq.php#">Terms & Service</a></li>
<li><a href="faq.php#">Payment Policy</a></li>
</ul>
</div>
</div>
</div>
...
<li><a href="faq.php#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="faq.php#"><i class="flaticon-pinterest-1"></i></a></li>
<li><a href="faq.php#"><i class="flaticon-linkedin"></i></a></li>
<li><a href="faq.php#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="faq.php#"><i class="flaticon-twitter-1"></i></a></li>
</ul>
</div>
...
<div class="col-lg-6 ">
<div class="footer-copyring"> <p>Copyright 2021 EG Shop Fashion | Design By <a href="faq.php#">Egens Lab</a></p> </div>
</div>
<div class="col-lg-6">

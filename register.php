...
<li><a href="register.php#"><i class="flaticon-heart"></i></a></li>
<li class="cart-icon">
...
<li><a href="register.php#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="register.php#"><i class="flaticon-twitter-1"></i></a></li>
<li><a href="register.php#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="register.php#"><i class="flaticon-pinterest-1"></i></a></li>
</ul>
</nav>
</div>
...
<a href="register.php#" class="resister-btn active">Register</a>
...
<label for="form-check">I agree to the <a href="register.php#">Terms & Policy</a></label>
</div>
...
<li><a href="register.php#" class="facebook-login"><i class="flaticon-facebook-app-symbol"></i> Sign
up with facebook</a></li>
<li><a href="register.php#" class="google-login"><i class="flaticon-pinterest-1"></i> Signup with
google</a></li>
</ul>
</div>
</div>
...
<li><a href="register.php#">Terms & Conditions</a></li>
<li><a href="register.php#">Our Support</a></li>
<li><a href="register.php#">Terms & Service</a></li>
<li><a href="register.php#">Payment Policy</a></li>
</ul>
</div>
</div>
</div>
...
<li><a href="register.php#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="register.php#"><i class="flaticon-pinterest-1"></i></a></li>
<li><a href="register.php#"><i class="flaticon-linkedin"></i></a></li>
<li><a href="register.php#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="register.php#"><i class="flaticon-twitter-1"></i></a></li>
</ul>
</div>
...
<div class="col-lg-6 ">
<div class="footer-copyring"> <p>Copyright 2021 EG Shop Fashion | Design By <a href="register.php#">Egens Lab</a></p> </div>
</div>
<div class="col-lg-6">

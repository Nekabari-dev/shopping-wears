...
<li class="category-icon"><a href="register.php?id=<?php echo $id; ?>#"><i class="flaticon-menu"></i></a></li>
<li><a href="dashboard.php?id=<?php echo $id; ?>"><i class="flaticon-user"></i></a></li>
<li><a href="register.php?id=<?php echo $id; ?>#"><i class="flaticon-heart"></i></a></li>
<li class="cart-icon">
...
<li><a href="register.php?id=<?php echo $id; ?>#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="register.php?id=<?php echo $id; ?>#"><i class="flaticon-twitter-1"></i></a></li>
<li><a href="register.php?id=<?php echo $id; ?>#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="register.php?id=<?php echo $id; ?>#"><i class="flaticon-pinterest-1"></i></a></li>
</ul>
</nav>
</div>
...
<a href="register.php?id=<?php echo $id; ?>#" class="resister-btn active">Register</a>
<a href="login.php?id=<?php echo $id; ?>" class="login-btn">Login</a>
</div>
</div>
</div>
...
<label for="form-check">I agree to the <a href="register.php?id=<?php echo $id; ?>#">Terms & Policy</a></label>
</div>
...
<li><a href="register.php?id=<?php echo $id; ?>#" class="facebook-login"><i class="flaticon-facebook-app-symbol"></i> Sign
up with facebook</a></li>
<li><a href="register.php?id=<?php echo $id; ?>#" class="google-login"><i class="flaticon-pinterest-1"></i> Signup with
google</a></li>
</ul>
</div>
</div>
...
<div class="contact-list">
<a href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#6f060109002f0a170e021f030a410c0002"><span class="__cf_email__" data-cfemail="3f565159507f5a475e524f535a115c5052">[email&#160;protected]</span></a>
<a href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#c7aea9a1a887b4b2b7b7a8b5b3e9a4a8aa"><span class="__cf_email__" data-cfemail="ed84838b82ad9e989d9d829f99c38e8280">[email&#160;protected]</span></a>
</div>
</li>
</ul>
</div>
...
<li><a href="register.php?id=<?php echo $id; ?>#">Privacy Policy</a> </li>
<li><a href="register.php?id=<?php echo $id; ?>#">Terms & Conditions</a></li>
<li><a href="register.php?id=<?php echo $id; ?>#">Our Support</a></li>
<li><a href="register.php?id=<?php echo $id; ?>#">Terms & Service</a></li>
<li><a href="register.php?id=<?php echo $id; ?>#">Payment Policy</a></li>
</ul>
</div>
</div>
</div>
...
<input name="newsletter_email" required type="text" placeholder="Your Email">
...
<li><a href="register.php?id=<?php echo $id; ?>#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="register.php?id=<?php echo $id; ?>#"><i class="flaticon-pinterest-1"></i></a></li>
<li><a href="register.php?id=<?php echo $id; ?>#"><i class="flaticon-linkedin"></i></a></li>
<li><a href="register.php?id=<?php echo $id; ?>#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="register.php?id=<?php echo $id; ?>#"><i class="flaticon-twitter-1"></i></a></li>
</ul>
</div>
...
<div class="col-lg-6 ">
<div class="footer-copyring"> <p>Copyright 2021 EG Shop Fashion | Design By <a href="register.php?id=<?php echo $id; ?>#">Egens Lab</a></p> </div>
</div>
<div class="col-lg-6">

...
<li class="category-icon"><a href="order.php#"><i class="flaticon-menu"></i></a></li>
<li><a href="dashboard.php"><i class="flaticon-user"></i></a></li>
<li><a href="order.php#"><i class="flaticon-heart"></i></a></li>
<li class="cart-icon">
...
<li><a href="order.php#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="order.php#"><i class="flaticon-twitter-1"></i></a></li>
<li><a href="order.php#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="order.php#"><i class="flaticon-pinterest-1"></i></a></li>
</ul>
</nav>
</div>
...
<a href="order.php" class="active"><i class="flaticon-shopping-bag"></i> My Order</a>
<a href="setting.php"><i class="flaticon-settings"></i> Account Setting</a>
<a href="order.php#"><i class="flaticon-logout"></i> Logout</a>
</div>
</div>
...
<td class="order-active"><a href="order.php#"><i class="flaticon-visibility"></i></a></td>
</tr>
<tr>
...
<li><a href="order.php#">Privacy Policy</a> </li>
<li><a href="order.php#">Terms & Conditions</a></li>
<li><a href="order.php#">Our Support</a></li>
<li><a href="order.php#">Terms & Service</a></li>
<li><a href="order.php#">Payment Policy</a></li>
</ul>
</div>
</div>
</div>
...
<li><a href="order.php#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="order.php#"><i class="flaticon-pinterest-1"></i></a></li>
<li><a href="order.php#"><i class="flaticon-linkedin"></i></a></li>
<li><a href="order.php#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="order.php#"><i class="flaticon-twitter-1"></i></a></li>
</ul>
</div>
...
<div class="col-lg-6 ">
<div class="footer-copyring"> <p>Copyright 2021 EG Shop Fashion | Design By <a href="order.php#">Egens Lab</a></p> </div>
</div>
<div class="col-lg-6">

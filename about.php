...
<li class="category-icon"><a href="about.php#"><i class="flaticon-menu"></i></a></li>
<li><a href="dashboard.php"><i class="flaticon-user"></i></a></li>
<li><a href="about.php#"><i class="flaticon-heart"></i></a></li>
<li class="cart-icon">
...
<i class="flaticon-diamond"></i> Diamond
</button>
</h2>
...
<li><a href="about.php#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="about.php#"><i class="flaticon-twitter-1"></i></a></li>
<li><a href="about.php#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="about.php#"><i class="flaticon-pinterest-1"></i></a></li>
</ul>
</nav>
</div>
...
<a href="about.php#" class="primary-btn-l">Read More</a>
</div>
</div>
</div>
</div>
...
<a href="about.php#"><i class="flaticon-symbols-3"></i></a>
</div>
</div>
<div class="col-lg-2 col-md-2 col-sm-3 col-6">
<div class="single-logo">
<a href="about.php#"><i class="flaticon-massachusetts-institute-of-technology-logotype"></i></a>
</div>
</div>
<div class="col-lg-2 col-md-2 col-sm-3 col-6">
<div class="single-logo">
<a href="about.php#"><i class="flaticon-my-life-social-logo"></i></a>
</div>
</div>
<div class="col-lg-2 col-md-2 col-sm-3 col-6">
<div class="single-logo">
<a href="about.php#"><i class="flaticon-stanford-university-logo"></i></a>
</div>
</div>
<div class="col-lg-2 col-md-2 col-sm-3 col-6">
<div class="single-logo">
<a href="about.php#"><i class="flaticon-club-dante-social-logotype"></i></a>
</div>
</div>
<div class="col-lg-2 col-md-2 col-sm-3 col-6">
<div class="single-logo">
<a href="about.php#"><i class="flaticon-funny-or-die-logo"></i></a>
</div>
</div>
<div class="col-lg-2 col-md-2 col-sm-3 col-6">
<div class="single-logo">
<a href="about.php#"><i class="flaticon-tuenti-social-logo"></i></a>
</div>
</div>
<div class="col-lg-2 col-md-2 col-sm-3 col-6">
<div class="single-logo">
<a href="about.php#"><i class="flaticon-ning-social-logo"></i></a>
</div>
</div>
<div class="col-lg-2 col-md-2 col-sm-3 col-6">
<div class="single-logo">
<a href="about.php#"><i class="flaticon-gather-logo"></i></a>
</div>
</div>
<div class="col-lg-2 col-md-2 col-sm-3 col-6">
<div class="single-logo">
<a href="about.php#"><i class="flaticon-inside-the-hotel-logotype"></i></a>
</div>
</div>
<div class="col-lg-2 col-md-2 col-sm-3 col-6">
<div class="single-logo">
<a href="about.php#"><i class="flaticon-virus-total-text-logo"></i></a>
</div>
</div>
<div class="col-lg-2 col-md-2 col-sm-3 col-6">
<div class="single-logo">
<a href="about.php#"><i class="flaticon-blogbus-logo"></i></a>
</div>
</div>
</div>
</div>
...
<li><a href="about.php#">Terms & Service</a></li>
<li><a href="about.php#">Payment Policy</a></li>
</ul>
</div>
</div>
</div>
...
<li><a href="about.php#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="about.php#"><i class="flaticon-pinterest-1"></i></a></li>
<li><a href="about.php#"><i class="flaticon-linkedin"></i></a></li>
<li><a href="about.php#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="about.php#"><i class="flaticon-twitter-1"></i></a></li>
</ul>
</div>
...
<div class="col-lg-6 ">
<div class="footer-copyring"> <p>Copyright 2021 EG Shop Fashion | Design By <a href="about.php#">Egens Lab</a></p> </div>
</div>
<div class="col-lg-6">

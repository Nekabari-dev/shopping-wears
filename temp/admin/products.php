                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group my-2">
                        ...
                        <select name="categ" Required>
                            ...
                            <option value="Top">Tops (Unisex)</option>
                            <option value="Bottom">Bottoms (Unisex)</option>
                            <option value="Footwear">Footwear (Unisex)</option>
                            <option value="Native">Men (Native Outfits)</option>
                        </select>
                    </div>

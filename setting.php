...
<li class="category-icon"><a href="setting.php?id=<?php echo $id; ?>#"><i class="flaticon-menu"></i></a></li>
<li><a href="temp/admin/login.php?id=<?php echo $id; ?>"><i class="flaticon-user"></i></a></li>
<li><a href="setting.php?id=<?php echo $id; ?>#"><i class="flaticon-heart"></i></a></li>
<li class="cart-icon">
...
<li><a href="setting.php?id=<?php echo $id; ?>#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="setting.php?id=<?php echo $id; ?>#"><i class="flaticon-twitter-1"></i></a></li>
<li><a href="setting.php?id=<?php echo $id; ?>#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="setting.php?id=<?php echo $id; ?>#"><i class="flaticon-pinterest-1"></i></a></li>
</ul>
</nav>
</div>
...
<a href="setting.php?id=<?php echo $id; ?>" class="active"><i class="flaticon-settings"></i> Account Setting</a>
<a href="setting.php?id=<?php echo $id; ?>#"><i class="flaticon-logout"></i> Logout</a>
</div>
</div>
...
<div class="edit-icon"><i class="flaticon-edit"></i></div>
...
<div class="contact-list">
<a href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#a2cbccc4cde2c7dac3cfd2cec78cc1cdcf"><span class="__cf_email__" data-cfemail="e980878f86a98c91888499858cc78a8684">[email&#160;protected]</span></a>
<a href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#254c4b434a65565055554a57510b464a48"><span class="__cf_email__" data-cfemail="caa3a4aca58ab9bfbabaa5b8bee4a9a5a7">[email&#160;protected]</span></a>
</div>
</li>
</ul>
</div>
...
<li><a href="setting.php?id=<?php echo $id; ?>#">Privacy Policy</a> </li>
<li><a href="setting.php?id=<?php echo $id; ?>#">Terms & Conditions</a></li>
<li><a href="setting.php?id=<?php echo $id; ?>#">Our Support</a></li>
<li><a href="setting.php?id=<?php echo $id; ?>#">Terms & Service</a></li>
<li><a href="setting.php?id=<?php echo $id; ?>#">Payment Policy</a></li>
</ul>
</div>
</div>
</div>
...
<li><a href="setting.php?id=<?php echo $id; ?>#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="setting.php?id=<?php echo $id; ?>#"><i class="flaticon-pinterest-1"></i></a></li>
<li><a href="setting.php?id=<?php echo $id; ?>#"><i class="flaticon-linkedin"></i></a></li>
<li><a href="setting.php?id=<?php echo $id; ?>#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="setting.php?id=<?php echo $id; ?>#"><i class="flaticon-twitter-1"></i></a></li>
</ul>
</div>
...
<div class="col-lg-6 ">
<div class="footer-copyring"> <p>Copyright 2021 EG Shop Fashion | Design By <a href="setting.php?id=<?php echo $id; ?>#">Egens Lab</a></p> </div>
</div>
<div class="col-lg-6">

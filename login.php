...
<li class="category-icon"><a href="login.php#"><i class="flaticon-menu"></i></a></li>
<li><a href="dashboard.php"><i class="flaticon-user"></i></a></li>
<li><a href="login.php#"><i class="flaticon-heart"></i></a></li>
<li class="cart-icon">
...
<li><a href="login.php#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="login.php#"><i class="flaticon-twitter-1"></i></a></li>
<li><a href="login.php#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="login.php#"><i class="flaticon-pinterest-1"></i></a></li>
</ul>
</nav>
</div>
...
<a href="register.php" class="resister-btn">Register</a>
...
<a href="login.php#">Forgotten password?</a>
</div>
</div>
...
<li><a href="login.php#" class="facebook-login"><i class="flaticon-facebook-app-symbol"></i> Sign
up whit facebook</a></li>
<li><a href="login.php#" class="google-login"><i class="flaticon-pinterest-1"></i> Signup whit
google</a></li>
</ul>
</div>
</div>
...
<li><a href="login.php#">Our Support</a></li>
<li><a href="login.php#">Terms & Service</a></li>
...
<li><a href="login.php#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="login.php#"><i class="flaticon-pinterest-1"></i></a></li>
<li><a href="login.php#"><i class="flaticon-linkedin"></i></a></li>
<li><a href="login.php#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="login.php#"><i class="flaticon-twitter-1"></i></a></li>
</ul>
</div>
...
<div class="col-lg-6 ">
<div class="footer-copyring"> <p>Copyright 2021 EG Shop Fashion | Design By <a href="login.php#">Egens Lab</a></p> </div>
</div>
<div class="col-lg-6">

...
<li class="category-icon"><a href="login.php?id=<?php echo $id; ?>#"><i class="flaticon-menu"></i></a></li>
<li><a href="dashboard.php?id=<?php echo $id; ?>"><i class="flaticon-user"></i></a></li>
<li><a href="login.php?id=<?php echo $id; ?>#"><i class="flaticon-heart"></i></a></li>
<li class="cart-icon">
...
<li><a href="login.php?id=<?php echo $id; ?>#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="login.php?id=<?php echo $id; ?>#"><i class="flaticon-twitter-1"></i></a></li>
<li><a href="login.php?id=<?php echo $id; ?>#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="login.php?id=<?php echo $id; ?>#"><i class="flaticon-pinterest-1"></i></a></li>
</ul>
</nav>
</div>
...
<a href="register.php?id=<?php echo $id; ?>" class="resister-btn">Register</a>
<a href="login.php?id=<?php echo $id; ?>#" class="login-btn active">Login</a>
</div>
</div>
</div>
...
<input name="first_name" type="text" id="fname" placeholder="Your first name" required>
</div>
<div class="reg-input-group">
<label for="password">Password *</label>
<input name="pword" type="password" id="password" placeholder="Enter your password" required>
</div>
...
<a href="login.php?id=<?php echo $id; ?>#">Forgotten password?</a>
</div>
</div>
<div class="reg-input-group reg-submit-input d-flex align-items-center">
<input name="login" type="submit" id="submite-btn" value="LOG IN">
</div>
</form>
...
<li><a href="login.php?id=<?php echo $id; ?>#" class="facebook-login"><i class="flaticon-facebook-app-symbol"></i> Sign
up whit facebook</a></li>
<li><a href="login.php?id=<?php echo $id; ?>#" class="google-login"><i class="flaticon-pinterest-1"></i> Signup whit
google</a></li>
</ul>
</div>
</div>
...
<div class="contact-list">
<a href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#88e1e6eee7c8edf0e9e5f8e4eda6ebe7e5"><span class="__cf_email__" data-cfemail="a2cbccc4cde2c7dac3cfd2cec78cc1cdcf">[email&#160;protected]</span></a>
<a href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#3950575f56794a4c4949564b4d175a5654"><span class="__cf_email__" data-cfemail="e28b8c848da2919792928d9096cc818d8f">[email&#160;protected]</span></a>
</div>
</li>
</ul>
</div>
...
<li><a href="login.php?id=<?php echo $id; ?>#">Privacy Policy</a> </li>
<li><a href="login.php?id=<?php echo $id; ?>#">Terms & Conditions</a></li>
<li><a href="login.php?id=<?php echo $id; ?>#">Our Support</a></li>
<li><a href="login.php?id=<?php echo $id; ?>#">Terms & Service</a></li>
<li><a href="login.php?id=<?php echo $id; ?>#">Payment Policy</a></li>
</ul>
</div>
</div>
</div>
...
<li><a href="login.php?id=<?php echo $id; ?>#"><i class="flaticon-facebook-app-symbol"></i></a></li>
<li><a href="login.php?id=<?php echo $id; ?>#"><i class="flaticon-pinterest-1"></i></a></li>
<li><a href="login.php?id=<?php echo $id; ?>#"><i class="flaticon-linkedin"></i></a></li>
<li><a href="login.php?id=<?php echo $id; ?>#"><i class="flaticon-instagram-2"></i></a></li>
<li><a href="login.php?id=<?php echo $id; ?>#"><i class="flaticon-twitter-1"></i></a></li>
</ul>
</div>
...
<div class="col-lg-6 ">
<div class="footer-copyring"> <p>Copyright 2021 EG Shop Fashion | Design By <a href="login.php?id=<?php echo $id; ?>#">Egens Lab</a></p> </div>
</div>
<div class="col-lg-6">
